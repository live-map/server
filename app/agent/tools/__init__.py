...
from app.agent.tools.search import search_news_ddg, search_news_gdelt, search_web, search_web_free
...
3. Use search_web_free for general searches (filtered)
